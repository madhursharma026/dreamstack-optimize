        ...
        <div className={`${styles.ContainerWidth} py-5 px-md-5 px-3`}>
            ...
            <div className="row">
                <div className="col-lg-4 col-sm-6">
                    <Image src={Images23} alt='Dreamstack Brand 1 Image' className="w-100 h-100 p-5" />
                </div>
                <div className="col-lg-4 col-sm-6">
                    <Image src={Images24} alt='Dreamstack Brand 2 Image' className="w-100 h-100 p-5" />
                </div>
                <div className="col-lg-4 col-sm-6">
                    <Image src={Images25} alt='Dreamstack Brand 3 Image' className="w-100 h-100 p-5" />
                </div>
                <div className="col-lg-4 col-sm-6">
                    <Image src={Images26} alt='Dreamstack Brand 4 Image' className="w-100 h-100 p-5" />
                </div>
                <div className="col-lg-4 col-sm-6">
                    <Image src={Images27} alt='Dreamstack Brand 5 Image' className="w-100 h-100 p-5" />
                </div>
                <div className="col-lg-4 col-sm-6">
                    <Image src={Images28} alt='Dreamstack Brand 6 Image' className="w-100 h-100 p-5" />
                </div>
            </div>
        </div>
    )
