                ...
                <Accordion>
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3">
                                    <Image src={Images10} alt='Dreamstack Dreamstack Customer Intelligence & Insights Image' className='w-100 h-auto' />
                                </div>
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={Images11} alt='Dreamstack Dreamstack Customer Intelligence & Insights Image' className='w-100 h-auto' />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                    ...
                    <Accordion.Item eventKey="2">
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={Images12} alt='Dreamstack Dreamstack Customer Intelligence & Insights Image' className='w-100 h-auto' />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                    ...
                    <Accordion.Item eventKey="3">
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={Images13} alt='Dreamstack Dreamstack Customer Intelligence & Insights Image' className='w-100 h-auto' />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
