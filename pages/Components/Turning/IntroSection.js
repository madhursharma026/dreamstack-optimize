                ...
                <div className="row">
                    <div className={`${styles.imgStyle} col-xl-6 col-lg-5 order-lg-2 pb-lg-0 pb-3`}>
                        <div className={`m-lg-0 m-5 mb-lg-0 mb-3`}>
                            <Image src={Images1} alt='Dreamstack AI Image' className='w-100 h-auto' />
                        </div>
                    </div>
                    <div className={`col-xl-6 col-lg-7 py-5 mt-xxl-5`}>
                        ...
                        <div className="row">
                            <div className="col-sm-2 col-3 mt-3 offset-sm-0 offset-1">
                                <Image src={Images2} alt='Dreamstack Trusted AI and machine learning Image' className='h-auto' style={{ width: '100%' }} />
                            </div>
                            <div className="col-sm-2 col-3 mt-4">
                                <Image src={Images3} alt='Dreamstack Trusted AI and machine learning Image' className='h-auto' style={{ width: '100%' }} />
                            </div>
                            <div className="col-sm-3 col-4 mt-4">
                                <Image src={Images4} alt='Dreamstack Trusted AI and machine learning Image' className='h-auto' style={{ width: '100%' }} />
                            </div>
                            <div className="col-sm-2 col-4 mt-3 offset-sm-0 offset-1">
                                <Image src={Images5} alt='Dreamstack Trusted AI and machine learning Image' className='h-auto' style={{ width: '100%' }} />
                            </div>
                            <div className="col-sm-1 col-2 mt-4">
                                <Image src={Images6} alt='Dreamstack Trusted AI and machine learning Image' className='h-auto' style={{ width: '100%' }} />
                            </div>
                            <div className="col-sm-2 col-3 mt-sm-2 mt-4">
                                <Image src={Images7} alt='Dreamstack Trusted AI and machine learning Image' className='h-auto' style={{ width: '100%' }} />
                            </div>
                        </div>
                    </div>
                </div>
