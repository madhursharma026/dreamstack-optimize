        ...
        <div className={`${styles.ContainerWidth}`}>
            ...
            <div className="row text-center">
                <div className="col-sm-6">
                    ...
                    <Image src={Images29} alt='Dreamstack Ransomware Attacks Image' style={{maxWidth:'300px', width:'100%'}} />
                ...
                <div className="col-sm-6">
                    <div className='p-lg-4 p-3' style={{ background: '#F0F0F0', height:'100%' }}>
                    <Image src={Images30} alt='Dreamstack Ransomware Attacks Image' style={{maxWidth:'300px', width:'100%'}} />
