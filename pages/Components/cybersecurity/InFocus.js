                ...
                <div className="row">
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image13} alt='Dreamstack Cybersecurity Image' className='w-100 h-100' />
                    ...
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image14} alt='Dreamstack Cybersecurity Image' className='w-100 h-100' />
                            <p className={`${styles.sectionBody} text-black`}>A global credit bureau secures credit scores</p>
                            <h6 className="text-muted">Case Studies | 18 May 2022</h6>
                        </div>
                    </div>
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image15} alt='Dreamstack Cybersecurity Image' className='w-100 h-100' />
                            <p className={`${styles.sectionBody} text-black`}>A global credit bureau secures credit scores</p>
                            <h6 className="text-muted">Case Studies | 18 May 2022</h6>
                        </div>
                    </div>
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image16} alt='Dreamstack Cybersecurity Image' className='w-100 h-100' />
                            <p className={`${styles.sectionBody} text-black`}>A global credit bureau secures credit scores</p>
                            <h6 className="text-muted">Case Studies | 18 May 2022</h6>
                        </div>
                    </div>
