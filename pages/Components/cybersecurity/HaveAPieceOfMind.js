                ...
                <div className="row px-lg-5">
                    <div className="col-md-6 mt-lg-5 mt-3">
                        <p className={`${styles.sectionBody} text-danger`}>
                            <Image src={Images17} alt='Dreamstack Website Scanning Image' style={{ width: "60px", height: '70px', paddingTop: '10px' }} />
                    ...
                    <div className="col-md-6 mt-lg-5 mt-3">
                        <p className={`${styles.sectionBody} text-danger`}>
                            <Image src={Images18} alt='Dreamstack Website Scanning Image' style={{ width: "60px", height: '70px', paddingTop: '10px' }} />
                    ...
                    <div className="col-md-6 mt-lg-5 mt-3">
                        <p className={`${styles.sectionBody} text-danger`}>
                            <Image src={Images19} alt='Dreamstack Website Scanning Image' style={{ width: "60px", height: '70px', paddingTop: '10px' }} />
                    ...
                    <div className="col-md-6 mt-lg-5 mt-3">
                        <p className={`${styles.sectionBody} text-danger`}>
                            <Image src={Images20} alt='Dreamstack Website Scanning Image' style={{ width: "60px", height: '70px', paddingTop: '10px' }} />
                    ...
                    <div className="col-md-6 mt-lg-5 mt-3">
                        <p className={`${styles.sectionBody} text-danger`}>
                            <Image src={Images21} alt='Dreamstack Website Scanning Image' style={{ width: "60px", height: '70px', paddingTop: '10px' }} />
                    ...
                    <div className="col-md-6 mt-lg-5 mt-3">
                        <p className={`${styles.sectionBody} text-danger`}>
                            <Image src={Images22} alt='Dreamstack Website Scanning Image' style={{ width: "60px", height: '70px', paddingTop: '10px' }} />
