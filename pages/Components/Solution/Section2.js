...
import Images2 from "../../media/Solution-Images/solution-image-2.png";
            ...
            <div className={`${styles.ContainerWidth}`}>
                <div className={`row`}>
                    <div className={`col-lg-6 text-center ${styles.imageColumn}`}>
                        <Image src={Images2} alt='Dreamstack Timesheet Battle Image' className={`w-100 h-100`} />
                    </div>
                    <div className={`col-lg-6 pb-lg-0 pb-5 pt-lg-0 pt-5 px-lg-5`}>
                        ...
                        <div className={`${styles.timelines} ${styles.education}`}>
