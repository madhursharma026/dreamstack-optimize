...
import Img1 from "./media/Login/Image1.png";
                    ...
                    <div className={`${styles.ContainerWidth} ${styles.Section1}`}>
                        <div className="row">
                            <div className="d-xl-block d-none col-xl-6 text-xl-center" style={{ margin: 'auto' }}>
                                <h3><Link href="/" style={{ textDecoration: 'none', color: 'black' }}>
                                    <Image src={Logo} alt='Dreamstack Logo Image' width={30} height={30} /> <b> DREAMSTACK</b></Link></h3>
                                <h3 className='mt-3'>Own Your Digital Presence</h3>
                                <Image src={Img1} alt='Dreamstack Digital Presence Image' className='w-100 h-auto' />
                            ...
                            <div className="col-xl-6 px-xl-5" style={{ textAlign: 'left' }}>
                                <div className="card w-100 p-xxl-5" style={{ boxShadow: '0 20px 35px rgba(0, 34, 69, 0.03), 0 20px 35px rgba(0, 0, 0, 0.06)' }}>
                                    <div className="card-body px-sm-5 px-4 py-5">
                                        <h3><Link href="/" style={{ textDecoration: 'none', color: 'black' }}>
                                            <Image src={Logo} alt='Dreamstack Logo Image' width={30} height={30} /> <b> DREAMSTACK</b></Link></h3>
                                        ...
                                        <form className='mt-4' onSubmit={(e) => loginWithEmailPassword(e)}>
                                            <div className="mb-4">
                                                <label for="exampleInputEmail1" className="form-label" style={{ color: '#434F58' }}><b>Email</b></label>
                                                <input type="email" className="form-control py-2" id="exampleInputEmail1" placeholder='Email' required style={{ background: '#E3F0FF' }} />
                                            </div>
                                            <div className="mb-4">
                                                <label for="exampleInputPassword1" className="form-label" style={{ color: '#434F58' }}><b>Password</b></label>
                                                <input type="password" className="form-control py-2" id="exampleInputPassword1" placeholder='Password' required style={{ background: '#E3F0FF' }} />
                                            </div>
                                            <button type="submit" className="btn btn-primary p-2 mt-2 w-100" style={{ borderRadius: '0' }}><b>Sign In</b></button>
                                            <div className="form-text mt-3">Forgot your password? <Link href="#" style={{ textDecoration: 'none' }}><b>Click here to reset</b></Link> </div>
                                            ...
                                            <button type="button" className="btn p-2 w-100" style={{ borderRadius: '0', border: '2px solid #0073EC' }} onClick={() => loginWithGoogle()}><b>Sign In</b></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
