                        ...
                        <div className={`${styles.ContainerWidth} ${styles.Section1}`}>
                            <div className="row py-lg-5 my-lg-5 px-lg-4">
                                <div className="col-md-10 col-lg-9 col-xl-8 col-xxl-7">
                                    ...
                                    <h1 className={`${styles.sectionTitle} pt-3 text-white`}>For more than a decade, we've been bucking Silicon Valley trends, taking our own approach to building products.</h1>
                                </div>
                            </div>
                        </div>
                    </div>
