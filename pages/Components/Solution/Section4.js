            ...
            <div className={`${styles.ContainerWidth} py-5`}>
                ...
                <div className={`row`}>
                    <div className={`col-lg-6 text-center ${styles.imageColumn}`}>
                        <Image src={Images6} alt='Dreamstack BUDGET REPORTS Image' className={`w-100 h-100`} />
                    </div>
                ...
                <div className="row" style={{ maxWidth: '1200px', margin: 'auto' }}>
                    <div className="col-lg-5 col-md-6 p-lg-5 pt-5 text-center">
                        <Image src={Images7} alt='Dreamstack BUDGET REPORTS Image' className={`${styles.imgWidth} h-100`} />
                    </div>
                    <div className="col-lg-7 col-md-6 p-lg-5 pt-5">
                        ...
                        <div className="row mt-xl-5 pt-xxl-5">
                            ...
                            <div className="col-6">
                                <Image src={Images8} alt='Dreamstack BUDGET REPORTS Image' className={`pt-lg-5`} style={{ float: 'right' }} height={100} width={150} />
                            </div>
                        </div>
                        <hr />
                        <div className="row">
