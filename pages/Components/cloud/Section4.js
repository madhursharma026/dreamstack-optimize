                ...
                <div className="py-md-5">
                    <div className="row py-5">
                        <div className="col-lg-6 text-center">
                            <Image src={Image8} alt='Dreamstack Research Organizations Image' width={'80%'} />
                        </div>
                        <div className="col-lg-6 px-md-5" style={{ margin: 'auto' }}>
                            ...
                            <div className={styles.scrnAfterMDScrn}>
                                ...
                                <button type="button" className="btn btn-dark py-2 px-4 mt-3 w-100"><b>Learn More</b></button>
                            </div>
                        </div>
                    </div>
                </div>
