...
export default function Section3() {
    return (
        <>
            <Image src={Img1} alt='Dreamstack Cutting-edge Technology Image' className='w-100 h-auto' />
                    ...
                    <div className="row">
                        ...
                        <div className="d-xl-block d-none col-xl-4" style={{ marginTop: '-200px' }}>
                            <div className="card w-100 h-100" style={{ background: '#F8F9FB', border: "none" }}>
                                <Image src={Img2} alt='Dreamstack Cutting-edge Technology Image' className="w-100 card-img-top" height='150' style={{ objectFit: 'cover' }} />
                        ...
                        <div className="col-md-6 col-xl-4">
                            <p className={`h-100 mt-md-0 mt-4 ${styles.h5CustomFont}`} style={{ lineHeight: '1.7', letterSpacing: '-0.2px' }}>
                                ...
                                <br />
                                <br />
                                Over the past decade, we've brought more than 55 products to the market. But, the R&D edge that drives this innovation isn't simple luck, it's the result of careful choice.
                            </p>
                        </div>
                        <div className="col-md-6 col-xl-4">
                            <p className={`h-100 mt-md-0 mt-4 ${styles.h5CustomFont}`} style={{ lineHeight: '1.7', letterSpacing: '-0.2px' }}>
