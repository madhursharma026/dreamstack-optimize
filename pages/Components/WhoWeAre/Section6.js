                ...
                <div className="py-lg-5">
                    <div className='section scrolling-section'>
                            ...
                            <div className="row">
                                ...
                                <div className='col-lg-6 col-7' style={{ overflowY: 'auto' }}>
                                    <div style={{ display: 'flex' }}>
                                        <div style={{ maxWidth: '100%', paddingLeft: '1rem', paddingRight: '1rem' }}>
                                            <h1 className={`${styles.sectionTitle}`}>
                                                Craftsmanship, as good as it gets
                                            </h1>
                                            <p className={`mt-3 ${styles.h5CustomFont}`} style={{ maxWidth: '400px', fontFamily: 'robotoslablight', lineHeight: '1.6', letterSpacing: '-0.3px', background: '#fff3e4', }}>Building software is best done in small teams, in informal environments. Numbers and metrics-only-driven approaches destroy creativity and result in soulless products.</p>
                                    ...
                                    <div style={{ display: 'flex' }}>
                                        <div style={{ maxWidth: '100%', paddingLeft: '1rem', paddingRight: '1rem' }}>
                                            ...
                                            <p className={`mt-3 ${styles.h5CustomFont}`} style={{ maxWidth: '400px', fontFamily: 'robotoslablight', lineHeight: '1.6', letterSpacing: '-0.3px', background: '#fff3e4', }}>Our mantra has always been to invest in people and products. That's why most of our investments go towards R&D.</p>
                                    ...
                                    <div style={{ display: 'flex' }}>
                                        <div style={{ maxWidth: '100%', paddingLeft: '1rem', paddingRight: '1rem' }}>
                                            ...
                                            <p className={`mt-3 ${styles.h5CustomFont}`} style={{ maxWidth: '400px', fontFamily: 'robotoslablight', lineHeight: '1.6', letterSpacing: '-0.3px', background: '#fff3e4', }}>We take great pride in our ability to reinvent ourselves.</p>
                                    ...
                                    <div style={{ display: 'flex' }}>
                                        <div style={{ maxWidth: '100%', paddingLeft: '1rem', paddingRight: '1rem' }}>
                                            ...
                                            <p className={`mt-3 ${styles.h5CustomFont}`} style={{ maxWidth: '400px', fontFamily: 'robotoslablight', lineHeight: '1.6', letterSpacing: '-0.3px', background: '#fff3e4', }}>We hire people for whom our existence truly makes a difference.</p>
                        ...
                        <div className="d-md-none d-block">
                            ...
                            <p className={`mt-3 ${styles.h5CustomFont}`} style={{ maxWidth: '400px', fontFamily: 'robotoslablight', lineHeight: '1.6', letterSpacing: '-0.3px', background: '#fff3e4', }}>We hire people for whom our existence truly makes a difference.</p>
                            <p className={`mt-3 ${styles.h5CustomFont}`} style={{ lineHeight: '1.6', letterSpacing: '-0.3px' }}>We think beyond the system of credentialism. That hiring policy and the goal of creating more jobs in rural communities, by itself, contributes to keeping our culture vital.</p>
                            <br />
                            <p className={`mt-3 ${styles.h5CustomFont}`} style={{ lineHeight: '1.6', letterSpacing: '-0.3px' }}>We've had programmers move to creative design, content writers switch to customer support, and copy editors transition into human resource roles. We do not believe that prior experience in one field should preclude pursuing another. Our employees, who’ve stayed with us for more than a decade, have spoken in great detail about such experiences in Humans of Dreamstack.</p>
                        </div>
                    </div>
