                        ...
                        <div className="row px-xxl-5">
                            <div className="col-lg-6 row mt-4">
                                <div className="col-2 col-sm-1 col-lg-2 col-xl-1">
                                    <Image src={Images16} alt="Dreamstack Banking and Finance Image" className="w-100 h-auto" />
                                </div>
                            ...
                            <div className="col-lg-6 row mt-4">
                                <div className="col-2 col-sm-1 col-lg-2 col-xl-1">
                                    <Image src={Images16} alt="Dreamstack eCommerce Image" className="w-100 h-auto" />
                                </div>
                                <div className="col-10 col-sm-11 col-lg-10 col-xl-11">
                            ...
                            <div className="col-lg-6 row mt-4">
                                <div className="col-2 col-sm-1 col-lg-2 col-xl-1">
                                    <Image src={Images16} alt="Dreamstack Healthcare Image" className="w-100 h-auto" />
                                </div>
                                <div className="col-10 col-sm-11 col-lg-10 col-xl-11">
                            ...
                            <div className="col-lg-6 row mt-4">
                                <div className="col-2 col-sm-1 col-lg-2 col-xl-1">
                                    <Image src={Images16} alt="Dreamstack Real Estate Image" className="w-100 h-auto" />
                                </div>
                                <div className="col-10 col-sm-11 col-lg-10 col-xl-11">
