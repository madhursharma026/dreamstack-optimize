            ...
            <div className={`py-5`}>
                <div className={`${styles.ContainerWidth}`}>
                    ...
                    <div className="row">
                            ...
                            <div className={styles.flipCard}>
                                <div className={styles.flipCardInner}>
                                    <div className={`${styles.flipCardFront} p-5`}>
                                        <Image src={Image9} alt='Dreamstack Customized Enterprise Image' />
                        ...
                        <div className="col-lg-4">
                            <div className={styles.flipCard}>
                                <div className={styles.flipCardInner}>
                                    <div className={`${styles.flipCardFront} p-5`}>
                                        <Image src={Image11} alt='Dreamstack Property Protected Image' />
                        ...
                        <div className="col-lg-4">
                            <div className={styles.flipCard}>
                                <div className={styles.flipCardInner}>
                                    <div className={`${styles.flipCardFront} p-5`}>
                                        <Image src={Image11} alt='Dreamstack GenAI Image' />
                    ...
                    <div className={styles.flipCardAfterLGScrn}>
                        <div className="card p-3 mt-3" style={{ border: 'none' }}>
