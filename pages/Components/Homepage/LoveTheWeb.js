...
export default function LoveTheWeb() {
    ...
    const visibleFormFunction = () => setVisibleForm(true);
        ...
        <div className={`pt-3 my-3 ${styles.ContainerWidth}`}>
            <div className="row px-3">
                <div className={`col-md-6 ${styles.imgSection}`}>
                    <Image src={Image16} alt="#ImgNotFound" />
                </div>
                <div className={`col-md-6 ${styles.formSection}`}>
                    {showNextData === false ? (
                        <form onSubmit={formSubmit}>
                            <h2 className={`${styles.sectionTitle}`}>Love the Web</h2>
                                ...
                                <>
                                    <div className="my-3">
                                        <Form.Group controlId="validationCustom02" style={{ width: '100%' }}>
                                            ...
                                            <Form.Select aria-label="Default select example" required className={`${styles.formInput}`}>
                                            ...
                                            <div className="col-6">
                                                <Form.Group controlId="validationCustom04" style={{ width: '100%' }}>
                                                    <b style={{ fontSize: '15px' }}>
                                                        <Form.Check label="Dreamstack Foundation" />
                                                    </b>
                                                </Form.Group>
                                            </div>
                                            <div className="col-6">
                                        ...
                                        <div className="row">
                                            <div className="col-6">
                                                <Form.Group controlId="validationCustom06" style={{ width: '100%' }}>
                                                    <b style={{ fontSize: '15px' }}>
                                                        <Form.Check type='radio' required inline label="HTML" name="group1" id={`inline-radio-1`} />
                                                    </b>
                                                </Form.Group>
                                            </div>
                                            <div className="col-6">
                                                <Form.Group controlId="validationCustom07" style={{ width: '100%' }}>
                                                    <b style={{ fontSize: '15px' }}>
                                                        <Form.Check type='radio' required inline label="TEXT" name="group1" id={`inline-radio-2`} />
                                                    </b>
                                                </Form.Group>
                                            </div>
                                        </div>
                                    ...
                                    <div className="my-3">
                                        <Form.Group controlId="validationCustom08" style={{ width: '100%' }}>
                                            <b style={{ fontSize: '15px' }}>
                                                <Form.Check required label="I’m okay with Dreamstack handling my info as explained in this Privacy Notice" />
                                            </b>
                                        </Form.Group>
                                    </div>
                                </>
