  ...
  return (
    <>
      <Snackbar open={open} autoHideDuration={2000} onClose={handleClose}>
        <Alert
          onClose={handleClose}
          className={`text-white bg-${AlertMessageBg}`}
        >
          {AlertMessage}
        </Alert>
      </Snackbar>
      <div className={`pb-5 mt-5`}>
          ...
          <div className={`${styles.ContainerWidth}`}>
            <div className={`row ${styles.IntroSection}`}>
              <div className={`col-xxl-6`} style={{ margin: 'auto' }}>
                <div
                  className={`py-xxl-5 ${styles.rightSide} px-3 mt-xxl-0 mt-5`}
                >
                  <h1
                    className={`${styles.sectionTitle} pt-md-5 pt-3 text-white`}
                  >
                    <b>Get fully managed tech services</b>
                  </h1>
                  <p className={`${styles.sectionBody} text-white`}>
                    Use Dreamstack to imagine, deliver, and run solutions to
                    your toughest business problems. Discover quality, speed,
                    and cost efficiency from our internal industry experts and
                    the fully managed teams they build for you.
                  </p>
                  <Link
                    className={`btn ${styles.openPositionBtn} px-4 py-3`}
                    href="/Turing"
                    role="button"
                  >
                  ...
                  <Link
                    className={`btn ${styles.salesBtn} px-4 py-3`}
                    href="/contact"
                    role="button"
                  >
                    <b>Talk to sales</b>
              ...
              <div
                className={`col-xxl-6 p-md-5 p-3 d-md-block d-none`}
                style={{
                  background: `url(${IntroSectionBG.src})`,
              ...
              >
                <div
                  class="card w-100 p-md-5 p-3 m-sm-5 m-3"
                  style={{
                    boxShadow:
                      '0 20px 35px rgba(0, 34, 69, 0.03), 0 20px 35px rgba(0, 0, 0, 0.06)',
                    maxWidth: '500px',
                    margin: 'auto',
                  }}
                >
                  <div class="card-body">
                    <h1
                      className="mt-sm-0 mt-4 text-center"
                      style={{ lineHeight: '1', fontWeight: 'bolder' }}
                    >
                      Try Dreamstack for your business
                    </h1>
                    <form className="mt-4" onSubmit={(e) => sendEmail(e)}>
                      ...
                      <input
                        ...
                        id="exampleCheck1"
                      />
                      <label class="form-text mt-2" for="exampleCheck1">
                        &nbsp; I agree to the Terms of Service and Privacy
                        Policy.
                      </label>
                      <button
                        type="submit"
                        class="btn p-2 w-100 mt-3"
                        style={{ background: '#F5BA31' }}
                      >
                        <b>Contact Now</b>
                      </button>
                    </form>
              ...
              <div
                className="d-md-none d-block text-center py-5 mb-5"
        ...
        >
          <div class="card w-100 d-sm-block d-none p-3 bg-black text-white rounded-5">
            <div class="card-body">
              <p className={`text-center ${styles.h3CustomFont}`}>
                <b>
                  Trusted by thousands of <br /> businesses worldwide
                </b>
              </p>
              <hr />
              <div className="row p-5">
                ...
                <div
                  className="col-lg-2 col-md-4 col-6 d-md-block d-none"
                  style={{ margin: 'auto', maxWidth: '200px' }}
                >
                  <div className={`${styles.bodyContainer1}`} />
                </div>
                ...
                <hr />
                <div
                  className="col-lg-3 col-md-4 col-6 d-md-block d-none"
                  style={{ margin: 'auto', maxWidth: '200px' }}
                >
                ...
                <div
                  className="col-lg-3 col-md-4 col-6 d-lg-block d-none"
                  style={{ margin: 'auto', maxWidth: '200px' }}
                >
