                ...
                <Accordion style={{ maxWidth: '1400px', margin: 'auto' }}>
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3">
                                    <Image src={CloudImage3} alt="Dreamstack Cloud Image" className='w-100 h-auto' />
                                </div>
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={CloudImage4} alt="Dreamstack Cloud Image" className='w-100 h-auto' />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                    ...
                    <Accordion.Item eventKey="2">
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={CloudImage5} alt="Dreamstack Cloud Image" className='w-100 h-auto' />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                    ...
                    <Accordion.Item eventKey="3">
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3">
                                    <Image src={CloudImage6} alt="Dreamstack Cloud Image" className='w-100 h-auto' />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                    ...
                    <Accordion.Item eventKey="4">
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3">
                                    <Image src={CloudImage7} alt="Dreamstack Cloud Image" className='w-100 h-auto' />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
