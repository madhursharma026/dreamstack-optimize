                ...
                <Accordion style={{ maxWidth: '1200px', margin: 'auto' }}>
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3">
                                    <Image src={Image9} alt='Dreamstack User Image' className="w-100 h-auto" />
                                </div>
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={Image10} alt='Dreamstack User Image' className="w-100 h-auto" />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                    ...
                    <Accordion.Item eventKey="2">
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={Image11} alt='Dreamstack User Image' className="w-100 h-auto" />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                    ...
                    <Accordion.Item eventKey="3">
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={Image12} alt='Dreamstack User Image' className="w-100 h-auto" />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
