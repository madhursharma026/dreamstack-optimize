                    ...
                    <div className="row py-lg-5 my-lg-5">
                        <div className="col-md-6">
                            <div className={styles.scrnBeforeMDScrn}>
                                ...
                                <Link href="/Turing" className={`btn btn-primary px-5 py-3`} role="button"><b>Get Started</b></Link>
                            </div>
                            <div className={styles.scrnAfterMDScrn}>
                                ...
                                <Link href="/" className={`btn btn-primary w-100 py-2`} role="button"><b>Get Started</b></Link>
                            </div>
                        </div>
                        <div className="col-md-6">
