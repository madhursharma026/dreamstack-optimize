            ...
            <div className={`py-5`}>
                <div className={`${styles.ContainerWidth}`}>
                        ...
                        <div className="row" style={{ maxWidth: '1200px', margin: 'auto' }}>
                            ...
                            <div className='col-xxl-7 col-8 px-4' style={{ overflowY: 'auto' }}>
                                <div id='column1' ref={columnRefs.column1}>
                                    ...
                                    <Image src={Img3} alt='Dreamstack Privacy Image' className='w-100 h-auto my-4' />
                                ...
                                <div id='column2' ref={columnRefs.column2}>
                                    ...
                                    <div className="row mt-4">
                                        <div className="col-lg-6">
                                            ...
                                            <br /><br />
                                            <span className={styles.sectionBody}>From how we build to how we hire, our unconventional approach has brought us to more than 15 employees and 100 thousands users around the world.</span>
                                        </div>
                                        <div className="col-lg-6" style={{ margin: 'auto' }}>
                                            <Image src={Img4} alt='Dreamstack Public Image' className='w-100 h-auto' style={{ maxHeight: '400px', objectFit: 'contain' }} />
                                        </div>
                                    </div>
                                </div>
                                <hr className='my-5' />
                                <div id='column3' ref={columnRefs.column3}>
                                    ...
                                    <div className="row mt-4">
                                        <div className="col-lg-6" style={{ margin: 'auto' }}>
                                            <Image src={Img5} alt='Dreamstack Privacy Image' className='w-100 h-auto' style={{ maxHeight: '400px', objectFit: 'contain' }} />
                                        </div>
                                        <div className="col-lg-6">
                                ...
                                <div id='column4' ref={columnRefs.column4}>
                                    ...
                                    <div className="row mt-4">
                                        <div className="col-lg-6">
                                            <span className={styles.sectionBody}>When you choose Dreamstack, you get more than a single product, suite, or platform. You get what we call the operating system for business, the result of more than a decade of engineering and design effort.</span>
                                            <br /><br />
                                        ...
                                        <div className="col-lg-6" style={{ margin: 'auto' }}>
                                            <Image src={Img6} alt='Dreamstack Business Image' className='w-100 h-auto' style={{ maxHeight: '400px', objectFit: 'contain' }} />
                                        </div>
                                    </div>
                                </div>
                                <hr className='my-5' />
                                <div id='column5' ref={columnRefs.column5}>
                                    ...
                                    <Image src={Img7} alt='Dreamstack Business Image' className='w-100 h-auto my-4' />
                                    <span className={styles.sectionBody}>
                                        <br />
                    ...
                    <div className='d-lg-none d-block'>
                        ...
                        <Image src={Img3} alt='Dreamstack Business Image' className='w-100 h-auto my-4' />
                        ...
                        <p className={`mt-3 ${styles.h5CustomFont}`}>
                            ...
                            <br /><br />
                            From how we build to how we hire, our unconventional approach has brought us to more than 15 employees and 100 thousands users around the world.
                        </p>
                        <Image src={Img13} alt='Dreamstack Business Image' className='w-100 h-auto my-4' />

                        <hr className='my-5' />

                        {/* <h1>A company you will keep</h1> */}
                        <p className={styles.h1CustomFont}>A company you will keep</p>
                        <Image src={Img14} alt='Dreamstack Business Image' className='w-100 h-auto my-4' />
                        ...
                        <p className={`${styles.h5CustomFont}`}>
                            When you choose Dream stack, you get more than a single product, suite, or platform. You get what we call the operating system for business, the result of more than a decade of engineering and design effort.
                            <br /><br />
                        ...
                        <Image src={Img15} alt='Dreamstack Business Image' className='w-100 h-auto my-4' />
                        ...
                        <p className={`mt-3 ${styles.h5CustomFont}`}>
                            As a global company, we understand the value of good citizenship. It's why we always try to give more than we get and why we are always looking for ways to support the communities in which we live.
                            <br />
                            <Image src={Img16} alt='Dreamstack Business Image' className='w-100 h-auto my-4' />
                            <br />
                            With more than 55 deeply integrated apps available on the web and mobile, we offer a solution to fit almost every business need. And if we haven't built it yet, you can bet we probably will soon.
                        </p>
                    </div>
