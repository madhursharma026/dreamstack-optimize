                ...
                <div className="row">
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image13} alt='Dreamstack Gartner Leader Image' className='w-100' style={{ height: '500px' }} />
                    ...
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image14} alt='Dreamstack Everest Ranking Image' className='w-100' style={{ height: '500px' }} />
                            <div className={`${styles.bottomLeft}`}>
                    ...
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image15} alt='Dreamstack IDC Marketscape Image' className='w-100' style={{ height: '500px' }} />
                            <div className={`${styles.bottomLeft}`}>
                    ...
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image16} alt='Dreamstack HFS Research Image' className='w-100' style={{ height: '500px' }} />
                            <div className={`${styles.bottomLeft}`}>
                                <h2>HFS Research</h2>
                            </div>
                        </div>
