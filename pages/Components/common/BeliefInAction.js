                ...
                <div className="row">
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image9} alt='Dreamstack Novolex Image' className='w-100' style={{ height: '300px' }} />
                            <div className='pt-3'>
                    ...
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image10} alt='Dreamstack Airlines Image' className='w-100' style={{ height: '300px' }} />
                            <div className='pt-3'>
                    ...
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image11} alt='Dreamstack Proximus Image' className='w-100' style={{ height: '300px' }} />
                            <div className='pt-3'>
                    ...
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image11} alt='Dreamstack Networks Image' className='w-100' style={{ height: '300px' }} />
                            <div className='pt-3'>
