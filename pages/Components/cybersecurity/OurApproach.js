            ...
            <div className={`${styles.ContainerWidth} py-4`}>
                ...
                <div className="row">
                    <div className="col-lg-3 col-sm-6 text-center py-3">
                        <Image src={Image4} alt='Dreamstack cybersecurity Image' className={`${styles.imgWidth}`} />
                        <h6 className='text-white pt-4'><b>Holistic cybersecurity strategy</b></h6>
                    </div>
                    <div className="col-lg-3 col-sm-6 text-center py-3">
                        <Image src={Image3} alt='Dreamstack Security Image' className={`${styles.imgWidth}`} />
                        <h6 className='text-white pt-4'><b>Security by design</b></h6>
                    </div>
                    <div className="col-lg-3 col-sm-6 text-center py-3">
                        <Image src={Image2} alt='Dreamstack risk Image' className={`${styles.imgWidth}`} />
                        <h6 className='text-white pt-4'><b>Proactive risk mitigation</b></h6>
                    </div>
                    <div className="col-lg-3 col-sm-6 text-center py-3">
                        <Image src={Image1} alt='Dreamstack Security Image' className={`${styles.imgWidth}`} />
