                ...
                <Accordion style={{ maxWidth: '1200px', margin: 'auto' }}>
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3">
                                    <Image src={Images10} alt='Dreamstack Customer Intelligence Image' className={`w-100`} />
                                </div>
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={Images11} alt='Dreamstack solution Image' className={`w-100`} />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                    ...
                    <Accordion.Item eventKey="2">
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={Images12} alt='Dreamstack Cloud platform Image' className={`w-100`} />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                    ...
                    <Accordion.Item eventKey="3">
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={Images13} alt='Dreamstack MasterCraft™ Image' className={`w-100`} />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                    ...
                    <Accordion.Item eventKey="4">
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3">
                                    <Image src={Images14} alt='Dreamstack solution Image' className={`w-100`} />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                                    <h4>Read how Dreamstack solution that can be deployed as a source to pay suite helps firms adopt agile sourcing & procurement, automate intelligently, & engage suppliers.  </h4>
                                </div>
                    ...
                    <Accordion.Item eventKey="5">
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={Images15} alt='Dreamstack MasterCraft™ Image' className={`w-100`} />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                                    <h4>Dreamstack MasterCraft™ optimizes processes across software development, QA, low-code development, digital transformation, enterprise data quality, and privacy.</h4>
                                </div>
                    ...
                    <Accordion.Item eventKey="6">
                        ...
                        <Accordion.Body>
                            <div className="row">
                                <div className="col-md-4 col-lg-3" style={{ maxHeight: '200px', overflow: 'hidden' }}>
                                    <Image src={Images16} alt='Dreamstack MasterCraft™ Image' className={`w-100`} />
                                </div>
                                <div className="col-md-8 col-lg-9 mt-md-0 mt-3">
                                    <h4>Dreamstack MasterCraft™ optimizes processes across software development, QA, low-code development, digital transformation, enterprise data quality, and privacy.</h4>
                                </div>
