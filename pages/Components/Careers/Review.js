        ...
        <div className={`${styles.ContainerWidth} px-md-4 px-3 pt-5`}>
            ...
            <Carousel variant="dark" indicators={false}>
                <Carousel.Item>
                    <div className="row" style={{ maxWidth: '1200px', margin: 'auto' }}>
                        <div className="col-lg-5 col-md-6 p-lg-5 pt-5 text-center">
                            <Image src={Images3} alt="Dreamstack Review User Image" className={`${styles.imgWidth}`} />
                        </div>
                ...
                <Carousel.Item>
                    <div className="row" style={{ maxWidth: '1200px', margin: 'auto' }}>
                        <div className="col-lg-5 col-md-6 p-lg-5 pt-5 text-center">
                            <Image src={Images4} alt="Dreamstack Review User Image" className={`${styles.imgWidth}`} />
                        </div>
                        <div className="col-lg-7 col-md-6 p-lg-5 pt-5">
                ...
                <Carousel.Item>
                    <div className="row" style={{ maxWidth: '1200px', margin: 'auto' }}>
                        <div className="col-lg-5 col-md-6 p-lg-5 pt-5 text-center">
                            <Image src={Images5} alt="Dreamstack Review User Image" className={`${styles.imgWidth}`} />
                        </div>
                        <div className="col-lg-7 col-md-6 p-lg-5 pt-5">
