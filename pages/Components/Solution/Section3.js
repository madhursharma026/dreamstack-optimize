        ...
        <div className={`p-0 px-md-4 px-3`} style={{ background: '#F2F8FF' }}>
            <div className={`${styles.ContainerWidth} py-5`}>
                ...
                <div style={{ maxWidth: '800px', margin: "auto" }}>
                    {(activeCard === "1") ?
                        <>
                            <Image src={Images3} alt='Dreamstack Card Image' className={`w-100 h-auto`} />
                        </>
                        :
                        <></>
                    }
                    {(activeCard === "2") ?
                        <>
                            <Image src={Images4} alt='Dreamstack Card Image' className={`w-100 h-auto`} />
                        </>
                        :
                        <></>
                    }
                    {(activeCard === "3") ?
                        <>
                            <Image src={Images5} alt='Dreamstack Card Image' className={`w-100 h-auto`} />
                        </>
                        :
                        <></>
                    }
