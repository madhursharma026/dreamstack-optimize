                ...
                <div className="row">
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image5} alt='Dreamstack Future Workforce Image' className='w-100' style={{ height: '400px' }} />
                    ...
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image6} alt='Dreamstack Sorting Image' className='w-100' style={{ height: '400px' }} />
                            <div className={`${styles.bottomLeft}`}>
                    ...
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image7} alt='Dreamstack Perils Image' className='w-100' style={{ height: '400px' }} />
                            <div className={`${styles.bottomLeft}`}>
                    ...
                    <div className="col-lg-3 col-sm-6 py-3">
                        <div className={`${styles.columnData}`}>
                            <Image src={Image8} alt='Dreamstack ransomware Image' className='w-100' style={{ height: '400px' }} />
                            <div className={`${styles.bottomLeft}`}>
